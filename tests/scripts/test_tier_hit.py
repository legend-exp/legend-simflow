...
def test_hit_script_cli(
    ...
    write_aoemeanmod_pars(pars_dir)
    ...
    is_valid_sim_vals = _field(first_det, "is_valid_sim")
    assert is_valid_sim_vals.dtype == bool, (
        f"is_valid_sim should be boolean, got {is_valid_sim_vals.dtype}"
    )
